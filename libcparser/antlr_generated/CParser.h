...
typedef struct CParser_Ctx_struct
{
    ...
    ANTLR3_BOOLEAN (*synpred230)	(struct CParser_Ctx_struct * ctx);
    ...
    ANTLR3_BOOLEAN (*synpred252)	(struct CParser_Ctx_struct * ctx);    unsigned char * (*getGrammarFileName)();
