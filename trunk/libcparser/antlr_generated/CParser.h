...
typedef struct CParser_Ctx_struct
{
    ...
    ANTLR3_BOOLEAN (*synpred194)	(struct CParser_Ctx_struct * ctx);
    ...
    ANTLR3_BOOLEAN (*synpred210)	(struct CParser_Ctx_struct * ctx);
    ...
    ANTLR3_BOOLEAN (*synpred227)	(struct CParser_Ctx_struct * ctx);
    ANTLR3_BOOLEAN (*synpred229)	(struct CParser_Ctx_struct * ctx);
    ANTLR3_BOOLEAN (*synpred233)	(struct CParser_Ctx_struct * ctx);
    ANTLR3_BOOLEAN (*synpred235)	(struct CParser_Ctx_struct * ctx);
    ANTLR3_BOOLEAN (*synpred251)	(struct CParser_Ctx_struct * ctx);
    ANTLR3_BOOLEAN (*synpred252)	(struct CParser_Ctx_struct * ctx);
    ANTLR3_BOOLEAN (*synpred253)	(struct CParser_Ctx_struct * ctx);
    ANTLR3_BOOLEAN (*synpred255)	(struct CParser_Ctx_struct * ctx);    unsigned char * (*getGrammarFileName)();
