...
/**
 * \brief Interface class to interact with the InSight daemon
 *
 * This interface class provides a convenient way to interact with the InSight
...
public:
    ...
    /**
     * Tries to connect to the InSight daemon.
    ...
    /**
     * Disconnects from the InSight daemon.
     */
    void disconnectFromDaemon();

    /**
     * Checks if the InSight daemon is running.
     * @return \c true if the daemon is running, \c false otherwise
     */
    bool isDaemonRunning();

    /**
     * Tries to start the InSight daemon.
     * \note the "insightd" executable must be available in the \c PATH or the
    ...
    /**
     * Tries to stop the InSight daemon.
     ...
     * \exception InsightError if the connection to the InSight daemon fails
     */
    ...
    /**
     * Evaluates the given command \a cmd in InSight's shell syntax and returns
